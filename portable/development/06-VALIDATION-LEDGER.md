...
| 2 | `v0.2.0 -> v0.3.0` | in progress | [Stage 2.1 request/closure/limits fixture gate accepted](evidence/stage2-1-contract-gate.md); implementation and no-I/O proof pending |
