...
inventory, immutable expected-result oracles, and future runner configuration.
Normative source fixtures remain under `portable/spec/v0/fixtures/` and must not
be duplicated here.
...
the ignored stage/profile hierarchy under `test-results/`.
